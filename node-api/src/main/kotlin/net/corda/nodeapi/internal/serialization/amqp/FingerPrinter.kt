...
interface FingerPrinter {
    abstract fun fingerprintForType(type: Type, contextType: Type?, alreadySeen: MutableSet<Type>,
                           hasher: Hasher, factory: SerializerFactory, debugIndent: Int = 1): Hasher
}

class FingerPrinterV1 : FingerPrinter {
...
// creating a unique string for a type which we then hash in the calling function above.
    override fun fingerprintForType(type: Type, contextType: Type?, alreadySeen: MutableSet<Type>,
                                   hasher: Hasher, factory: SerializerFactory, debugIndent: Int = 1): Hasher {
